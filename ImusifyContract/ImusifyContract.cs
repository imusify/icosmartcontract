...
namespace Imusify.Contracts
{
    public class ImusifyContract : SmartContract
    {
        public static readonly byte[] Developers_Address = "AdgNxYeRq4p7mGAaQMHB2Y7zpAGnxNs4fQ".ToScriptHash();
        ...
        public static BigInteger TotalSupply() => 1000000000 * imu_decimals;
